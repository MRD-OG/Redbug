package mc.md5g22.redbug.plugin;

import io.papermc.paper.plugin.lifecycle.event.types.LifecycleEvents;
import mc.md5g22.redbug.listeners.NodePlacerListener;
import mc.md5g22.redbug.objects.monitor.MonitorManager;
import mc.md5g22.redbug.objects.test.TestManager;
import mc.md5g22.redbug.commands.MonitorCommand;
import mc.md5g22.redbug.commands.PinCommand;
import mc.md5g22.redbug.commands.TestCommand;
import mc.md5g22.redbug.commands.WireCommand;
...
public final class Redbug extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        vcdManager = VcdManager.getInstance(this);
        ...
        vcdManager.setMonitorManager(monitorManager);
